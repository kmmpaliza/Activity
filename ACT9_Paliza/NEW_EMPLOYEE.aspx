<%@ Page Title="" Language="C#" MasterPageFile="~/MASTERPAGE.Master" AutoEventWireup="true" CodeBehind="NEW_EMPLOYEE.aspx.cs" Inherits="ACT9_Paliza.NEW_EMPLOYEE" %>
        ...
        <tr>
            <td class="style6">
                <asp:Button ID="Button1" runat="server" CssClass="style8" Height="31px" 
                    onclick="Button1_Click" Text="SAVE" Width="143px" />
            </td>
            <td class="style7">
